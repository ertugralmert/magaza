...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerSatisException(ProductManagementException productManagementException) {
        return new ResponseEntity<>(createMessage(productManagementException.getErrorType(), productManagementException), productManagementException.getErrorType().getHttpStatus());
    }
    ...
    public ResponseEntity<ErrorMessage> handlerMethodArgumentNotValidException(MethodArgumentNotValidException exception) {
        ...
        exception.getBindingResult().getFieldErrors().forEach(x -> fields.add(x.getField() + ": " + x.getDefaultMessage()));
    ...
    public final ResponseEntity<ErrorMessage> handleJDBCConnectionException(HttpMessageNotReadableException exception) {
